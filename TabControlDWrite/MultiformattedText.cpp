...
HRESULT MultiformattedText::Initialize(HWND hwndParent)
{
  ...
  wcex.lpszClassName = L"D2DMultiformattedText";
...
LRESULT CALLBACK MultiformattedText::WndProc(HWND hWnd, UINT message,
